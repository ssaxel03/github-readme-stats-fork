...
const DEFAULT_CARD_WIDTH = 283;
const MIN_CARD_WIDTH = 100;
const DEFAULT_LANG_COLOR = "#e2e9ec";
const CARD_PADDING = 25;
const COMPACT_LAYOUT_BASE_HEIGHT = 90;
const MAXIMUM_LANGS_COUNT = 20;

const NORMAL_LAYOUT_DEFAULT_LANGS_COUNT = 3;
const COMPACT_LAYOUT_DEFAULT_LANGS_COUNT = 3;
const DONUT_LAYOUT_DEFAULT_LANGS_COUNT = 3;
const PIE_LAYOUT_DEFAULT_LANGS_COUNT = 3;
const DONUT_VERTICAL_LAYOUT_DEFAULT_LANGS_COUNT = 3;
